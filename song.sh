...
curl -s -X POST -H "Authorization: Bearer $HASS_TOKEN" -H "Content-Type: application/json" -d '{"attributes": {"friendly_name":  "Song"}, "entity_id": "input_boolean.song", "state": "'"$song"'"}'\
